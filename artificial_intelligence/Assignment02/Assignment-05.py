...
Original file is located at
    https://colab.research.google.com/drive/1CP96Vn2V9RJ8zpXed9L_mB2L6Fjj3KDj
"""

'''
05. 8-3.py의 36행에서 units을 16, 32, 64, 128, 256으로 
변화시키며 학습 및 평가를 수행하고, 
각 unit 수의 변화에 따른 평균절댓값백분율오차(MAPE) 결과를 첨부하시오.
+5번 학습 시 epoch 값을 100으로 낮춰 적용하세요.
'''
...
f=open("/content/drive/MyDrive/인공지능/과제2/BTC_USD_2019-02-28_2020-02-27-CoinDesk.csv","r")
